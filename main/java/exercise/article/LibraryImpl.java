...
public class LibraryImpl implements Library {
    ...
    public void store(int year, List<Article> articles) {
        System.out.println("Сохраняем, но не обновляем   новые статьи store");
    ...
    public void updateCatalog() {
        System.out.println("Обновляем каталог updateCatalog");
    ...
    public List<String> getAllTitles() {
        System.out.println("Формируем список названий статей getAllTitles");
