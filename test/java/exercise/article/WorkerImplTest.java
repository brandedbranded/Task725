...
class WorkerImplTest {
    ...
    private List<Article> newArticlesList;
    ...
    public void sameArticlesDefence() throws Exception {
        ...
        sameArticles.add(new Article("Same title", "Same content", "Same author", null));
        sameArticles.add(new Article("Same title", "Same content", "Same author", null));
    ...
    public void addNewArticle() {
        newArticlesList.add(new Article("MadeNewArticleTitle", "ContentContent", "AuthorAuthor", LocalDate.of(2023, 1, 1)));
    ...
    public void getTitlesFromCatalog() {
        when(library.getAllTitles()).thenReturn(List.of("ArticleTitle1", "ArticleTitle2", "ArticleTitle3"));
    ...
    @Test
    public void noTitle() {
        newArticlesList.add(new Article(null, "ContentContent", "AuthorAuthor", LocalDate.of(2023, 1, 1)));
    ...
    public void noContent() {
        newArticlesList.add(new Article("MadeNewArticleTitle", null, "AuthorAuthor", LocalDate.of(2023, 1, 1)));
        List<Article> article = worker.prepareArticles(newArticlesList);
        assertEquals(0, article.size());
    }
    ...
    public void noAuthor() {
        newArticlesList.add(new Article("MadeNewArticleTitle", "ContentContent", null, LocalDate.of(2023, 1, 1)));
        List<Article> article = worker.prepareArticles(newArticlesList);
        assertEquals(0, article.size());
    }
    ...
    public void setDateNow() {
        newArticlesList.add(new Article("MadeNewArticleTitle", "ContentContent", "AuthorAuthor", null));
